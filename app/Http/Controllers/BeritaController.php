...
class BeritaController extends Controller
{
    ...
    public function prosesTambah(Request $request){
        ...
        try{
            ...
            return redirect(route('berita.index'))->with('pesan', ['danger','Berita Tidak Berhasil di Tambahkan']);
    ...
    public function prosesUbah(Request $request){
        ...
        try{
            ...
            return redirect(route('berita.index'))->with('pesan', ['danger','Berita Tidak Berhasil di Ubah']);
    ...
    public function hapus($id){
        ...
        try{
            ...
            return redirect(route('berita.index'))->with('pesan', ['danger','Berita Gagal di hapus']);
